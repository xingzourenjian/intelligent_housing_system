...
void OLED_main_interface(void)
{
	OLED_Clear();
	OLED_ShowString(8, 0, "AI", OLED_8X16);
	OLED_ShowChinese(24, 0, "智能家居系统");
	OLED_ShowChinese(0,16,"温度：");
	OLED_ShowChinese(0,32,"湿度：");
	OLED_ShowChinese(0,48,"光照：");
	OLED_Update();
}
void OLED_two_interface(void)
{
	OLED_Clear();
	OLED_ShowString(8, 0, "AI", OLED_8X16);
	OLED_ShowChinese(24, 0, "智能家居系统");
	OLED_ShowChinese(0,16,"烟雾：");
	OLED_ShowChinese(0,32,"一氧化碳：");
	OLED_Update();
}
